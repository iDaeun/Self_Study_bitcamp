...
public class MainForSpring4 {
	...
	private static void processNewCommand(String[] args) {
		...
		MemberRegisterService2 service = ctx.getBean("registService2", MemberRegisterService2.class);
	...
	private static void processChangeCommand(String[] args) {
		...
		ChangePasswordService2 service = ctx.getBean("changePwService2", ChangePasswordService2.class);
