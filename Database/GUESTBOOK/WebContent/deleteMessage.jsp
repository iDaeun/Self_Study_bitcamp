<%@page import="guestbook_service.InvalidMessagePasswordException"%>
<%@page import="guestbook_service.MessageNotFoundException"%>
<%@page import="java.sql.SQLException"%>
<%@page import="guestbook_service.DeleteMessageService"%>
