<%@page import="guestbook_model.Message"%>
<%@page import="guestbook_model.MessageListView"%>
<%@page import="guestbook_service.GetMessageListService"%>
...
<body>
	...
	<div>
		...
		<%=message.getMessage()%><br> <a href="#">삭제하기</a>
	</div>
	<%
		}
		}
